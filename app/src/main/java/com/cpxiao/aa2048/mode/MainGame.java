...
public class MainGame {
    ...
    public MainGame(Context context, GameView view, int squareCountX, int squareCountY) {
        mContext = context;
        mView = view;
        endingMaxValue = (int) Math.pow(2, view.numCellTypes - 1);
        this.numSquaresX = squareCountX;
        this.numSquaresY = squareCountY;
    }
    ...
    private void recordHighScore() {
        PreferencesUtils.putLong(mContext, Extra.Key.BEST_SCORE, bestScore);
        //        SharedPreferences settings = PreferenceManager.getDefaultSharedPreferences(mContext);
        //        SharedPreferences.Editor editor = settings.edit();
        //        editor.putLong(Extra.Key.BEST_SCORE, bestScore);
        //        editor.commit();
    }

    private long getBestScore() {
        return PreferencesUtils.getLong(mContext, Extra.Key.BEST_SCORE, -1);
        //        SharedPreferences settings = PreferenceManager.getDefaultSharedPreferences(mContext);
        //        return settings.getLong(Extra.Key.BEST_SCORE, -1);
    }
